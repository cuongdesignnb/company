...
{
    wp_enqueue_style('cb-company-theme', get_template_directory_uri() . '/assets/css/main.css', [], '1.8.3');
    wp_enqueue_script('cb-company-theme', get_template_directory_uri() . '/assets/js/main.js', [], '1.8.3', true);
    if (cb_theme_has_multiple_hero_slides()) {
        wp_enqueue_script('cb-company-hero-slider', get_template_directory_uri() . '/assets/js/hero-slider.js', [], '1.8.3', true);
    }
}
